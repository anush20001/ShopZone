export const allItems = [
      ...
      listItem: [
        {
          _id: "002",
          listData: [
            "Sell products on ShopZone",
            "Sell on ShopZone Business",
            "Sell apps on ShopZone",
            "Become an Affiliate",
            "Advertise Your Products",
            "Sell Product with Us",
            "Host an ShopZone Hub",
      ...
      listItem: [
        {
          _id: "003",
          listData: [
            "ShopZone Business Card",
            "Shop with Points",
            "Reload Your Balance",
            "ShopZone Currency Converter",
          ],
        },
      ],
    },
  ...
  export const footerBottomItem = [
    {
      _id: 1001,
      title: "ShopZone Music",
      des: "Stream millions of songs",
    },
    {
      _id: 1002,
      title: "	ShopZone Advertising",
      des: "Find, attract, and engage customers",
    },
    {
      _id: 1003,
      title: "ShopZone Drive",
      des: "Cloud storage from ShopZone",
    },
    {
      _id: 1004,
      title: "6pm",
    ...
    {
      _id: 1007,
      title: "Sell on ShopZone",
      des: "Start a Selling Account",
    },
    {
      _id: 1008,
      title: "ShopZone Business",
      des: "Everything For Your Business",
    },
    {
      _id: 1009,
      title: "ShopZoneGlobal",
    ...
    {
      _id: 1031,
      title: "ShopZone Subscription Boxes",
