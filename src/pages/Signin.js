      ...
      <div className="w-full bg-gray-100 pb-10">     
         {
            ...
            <div className="w-full h-full flex justify-center items-center py-32 bg-white"> 
                <p className="    text-green-500 font-titleFont text-3xl font-semibold px-6 py-2">
                  <img src={wellcome2grp} alt="" className="w-40 mt-2" />
                       {successMsg}
                </p>
            </div>
