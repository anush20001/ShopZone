...
import  bdFlag  from "../../assests/bgFlag.png";
import logo5new from "../../assests/logo5new.png"
...
const FooterMiddle = () => {
  ...
  return (
    <div className="w-full bg-amazon_light text-white">
      ...
      <div className="w-full flex gap-6 items-center justify-center py-2">
        <div className="flex items-center">
          <img className=" w-16  pt-3 " src={logo5new} alt="logo" />
        </div>
